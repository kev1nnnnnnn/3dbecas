...
const Footer = () => {
    ...
    return (
        <footer className="w-full  from-blue-500 to-cyan-500 flex flex-col">
            <main className="w-full lg:pt-28 lg:pb-12 pt-20 pb-12 px-6 grid md:grid-cols-3 lg:gap-8 md:gap-5 gap-8 lg:px-32">
                <div className="flex flex-col gap-2">
                    <Link to={`/`} className="font-extrabold flex items-center relative md:text-3xl text-2xl">
                        <Text as="span" className="text-white">3D</Text>
                        <Text as="span" className=" bg-gradient-to-r from-blue-500 to-cyan-500 bg-clip-text text-transparent">Becas Sport Life</Text>
                    </Link>
                    ...
                    <ul className="flex flex-col gap-4">
                        {FooterTexts.contacts.names.map((name, index) => (
                            <List className="text-zinc-400 flex items-start gap-2" key={index}>
                               <Text as="span" className="text-blue-500 mt-1">{renderIcon(index)}</Text>
            ...
            <div className="text-center py-3 bg-gradient-to-r from-blue-500 to-cyan-500">
