...
import Offer from "../../assets/images/james-owen-c-NBiJrhwdM-unsplash.jpg"
...
const Offers = () => {
    ...
    const renderIcon = useCallback((element: number) => {
        switch (element) {
            case 0:
                return <SealCheck size={50} color="blue" weight="light" />;
            case 1:
                return <SealCheck size={50} color="blue" weight="light" />;
            case 2:
                return <SealCheck size={50} color="blue" weight="light" />;
    ...
    return (
        <section className="w-full h-auto mt-10 mb-10 flex items-center bg-zinc-900">
            <main className="w-full lg:h-[800px] grid md:grid-cols-2 items-center gap-10 md:gap-0 lg:gap-0 ">
                ...
                <div className="h-full w-full lg:px-10 px-4 flex flex-col lg:justify-center md:justify-end justify-center items-start md:gap-20 lg:gap-24 gap-16">
                    ...
                    <div className="w-full flex flex-col mt-10 lg:mt-24 items-center relative before:absolute before:-bottom-6 before:left-38 before:w-20 before:h-1 before:rounded-lg before:bg-gradient-to-r before:from-blue-500 before:to-cyan-500 z-10">
                    <Text as="p" className="text-blue-500 lg:text-sm text-xs tracking-widest uppercase font-medium">{OfferTexts.firstText}</Text>
                                ...
                                OfferTexts.list.map((item, index) => (
                                    <List className="flex lg:gap-6 gap-4 items-start justify-start" key={index}>
                                        ...
                                        <div className="flex flex-col gap-1">
                                            <Text as="h3" className="text-base text-blue-500 font-semibold">{item.listCaption}</Text>
